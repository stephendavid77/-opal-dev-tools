...
FORBIDDEN_DEPENDENCIES = {
    ...
    "shared-library": {
        ...
        "opal-global-ui": ["flask-jwt_extended"],
        "opal-auth-frontend": [],
    },
}
        ...
        with open(pyproject_path, "r") as f:
            ...
            for forbidden_dep in FORBIDDEN_DEPENDENCIES.get(project_type, []):
                if forbidden_dep in " ".join(project_dependencies):
                    violations.append(f"Forbidden dependency found in pyproject.toml: {forbidden_dep}")
        ...
        with open(requirements_path, "r") as f:
            ...
            for forbidden_dep in FORBIDDEN_DEPENDENCIES.get(project_type, []):
                if forbidden_dep in requirements_content:
                    violations.append(f"Forbidden dependency found in requirements.txt: {forbidden_dep}")
